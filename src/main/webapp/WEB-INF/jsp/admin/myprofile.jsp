...
<form:form action="/profile/${userEntity.username}" method="post" modelAttribute="profileModel">
    <div class="row profile-row">
        <div class="col-md-4 relative">
            <div class="avatar">
                <div class="avatar-bg center" id="background-ava"
                     style="background-image: url('data:image/png;base64, ${userEntity.base64Avatar}')"></div>
            </div>
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <form:input class="form-control" type="text" name="firstname" id="firstname"
                                    value="${userEntity.firstName}" path="firstName"/>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <form:input class="form-control" type="text" name="lastname" id="lastname"
                                    value="${userEntity.lastName}" path="lastName"/>
                    </div>
                </div>
            ...
            <div class="form-group mb-3">
                ...
                <form:input class="form-control" type="email" autocomplete="off" name="email" id="email"
                            value="${userEntity.email}" path="email"/>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <form:input class="form-control" name="social" id="social" autocomplete="off"
                                    value="${userEntity.social}" path="socialLink"/>
                    </div>
                </div>
                ...
                <sec:authorize access="hasRole('ADMIN')">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <form:input class="form-control" type="position" autocomplete="off" name="position"
                                        id="position" value="${userEntity.position}" path="position"/>
                    ...
                    <sec:authorize access="hasRole('ADMIN')">
                        <label class="switch">
                            <input type="checkbox" id="enabled" name="enabled"
                                   onclick="alert('If you turn off the switch and submit the form, your account will be disabled and you will not be able to login in future!');" ${userEntity.enabled ? 'checked' : ''}/>
...
<div class="container">
    ...
    <div class="row">
        ...
        ${draft.editable ? 'bg-primary' : (draft.published ? 'bg-success' : 'bg-warning')}">
                    ...
                    <a href="/profile/${draft.userEntity.username}"><small
                            class="text-muted">${draft.userEntity.firstName} ${draft.userEntity.lastName}</small></a>
                </a>
                <hr>
            </c:forEach>
        ...
        ${article.editable ? 'bg-primary' : (article.published ? 'bg-success' : 'bg-warning')}">
                    ...
                    <a href="/profile/${article.userEntity.username}"><small
                            class="text-muted">${article.userEntity.firstName} ${article.userEntity.lastName}</small></a>
                </a>
                <hr>
            </c:forEach>
